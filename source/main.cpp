...
#define IMGUI_DEMO_MARKER(section)  do { if (GImGuiDemoMarkerCallback0 != NULL) GImGuiDemoMarkerCallback0(__FILE__, __LINE__, section, GImGuiDemoMarkerCallbackUserData0); } while (0)
...
/*
  ...
  for (const auto &entry: std::filesystem::directory_iterator(folderPath))
  {
    ...
    if (memcmp(entry.path().c_str()+(len-4), ".obj", 4)) continue;
